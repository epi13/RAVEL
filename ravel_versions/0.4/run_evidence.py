#!/usr/bin/env python3
"""Run the preserved 0.4 evidence utility against its relocated case root."""
...
import ravel_0_4_evidence as evidence  # noqa: E402
...
evidence.build_manifest = digest.build_manifest
for name in (
    "PREREGISTRATION",
    "MANIFEST_SPEC",
    "RAW_EVIDENCE",
